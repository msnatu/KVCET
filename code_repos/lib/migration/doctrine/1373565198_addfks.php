...
class Addfks extends Doctrine_Migration_Base
{
    public function up()
    {
        ...
        $this->createForeignKey('student', 'student_student_id_sf_guard_user_id', array(
             'name' => 'student_student_id_sf_guard_user_id',
             'local' => 'student_id',
             'foreign' => 'id',
             'foreignTable' => 'sf_guard_user',
             ));
        $this->createForeignKey('student', 'student_department_department_id', array(
             'name' => 'student_department_department_id',
             'local' => 'department',
             'foreign' => 'id',
    ...
    public function down()
    {
        ...
        $this->dropForeignKey('student', 'student_student_id_sf_guard_user_id');
        $this->dropForeignKey('student', 'student_department_department_id');
    }
}