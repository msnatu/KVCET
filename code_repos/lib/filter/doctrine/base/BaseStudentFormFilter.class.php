...
abstract class BaseStudentFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'is_lateral'          => new sfWidgetFormChoice(array('choices' => array('' => 'yes or no', 1 => 'yes', 0 => 'no'))),
      'course_type'         => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('StudCourseCategory'), 'add_empty' => true)),
    ...
    $this->setValidators(array(
      ...
      'is_lateral'          => new sfValidatorChoice(array('required' => false, 'choices' => array('', 1, 0))),
      'course_type'         => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('StudCourseCategory'), 'column' => 'id')),
