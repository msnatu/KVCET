...
/**
 * StudentClassroom filter form base class.
 *
 * @package    KVCET
 * @subpackage filter
 * @author     Natu
 ...
 */
abstract class BaseStudentClassroomFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('student_classroom_filters[%s]');
