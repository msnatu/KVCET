...
abstract class BaseStudentForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'is_lateral'          => new sfWidgetFormInputCheckbox(),
    ...
    $this->setValidators(array(
      ...
      'is_lateral'          => new sfValidatorBoolean(array('required' => false)),
      'course_type'         => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('StudCourseCategory'), 'required' => false)),
