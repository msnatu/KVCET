<?php include_partial('global/page_title', array('title' => 'Adding New User', 'back_url' => 'otherUser/index', 'icon_class' => 'page-title-user-icon')); ?>
...
<div class="form-container">
    ...
    <form action="<?php echo url_for('otherUser/new'); ?>" method="POST" id="create_new">
        ...
        <?php echo $form->printSelectBox("add", "User Type", "user_group", $collgGroup['options'], $collgGroup['values'], 'a Group To Assign', "", 1); ?>
